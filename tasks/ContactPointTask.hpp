...
#ifndef ODOMETRY_CONTACTPOINTTASK_TASK_HPP
#define ODOMETRY_CONTACTPOINTTASK_TASK_HPP

#include "odometry/ContactPointTaskBase.hpp"
...
namespace odometry {
     ...
     * contact-point odometry applied to Asguard
     * \details
     ...
     */
    class ContactPointTask : public ContactPointTaskBase
    {
    ...
    public:
         ...
         */
        ContactPointTask(std::string const& name = "odometry::ContactPointTask");
